  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      if (sessionId === 'a27bc9b5-bb6a-4117-b11b-c9c8cddf76d0') {
        resolve([
          { id: '101', message: 'Xin chào! Tôi có thể giúp gì cho bạn?', sender:"BOT", createdAt: new Date('2023-10-01T10:01:00') },
          { id: '102', message: 'Tôi muốn học JavaScript, bắt đầu từ đâu là tốt nhất?', sender:"USER", createdAt: new Date('2023-10-01T10:00:00') },
          { id: '103', message: 'Bạn có thể bắt đầu với các khóa học cơ bản trên Codecademy hoặc freeCodeCamp.', sender:"BOT", createdAt: new Date('2023-10-01T10:02:00') }
        ]);
      } else if (sessionId === 'b38cd0e6-cc7b-5228-c22c-d0d9dee87bf1') {
        resolve([
          { id: '201', message: 'Chào bạn! Tôi có thể giúp gì hôm nay?', sender:"BOT", createdAt: new Date('2023-10-02T14:30:00') },
          { id: '202', message: 'React hooks hoạt động như thế nào?', sender:"USER", createdAt: new Date('2023-10-02T14:31:00') },
          { id: '203', message: 'React hooks cho phép bạn sử dụng state và các tính năng khác của React mà không cần viết class.', sender:"BOT", createdAt: new Date('2023-10-02T14:32:00') }
        ]);
      } else {
          resolve([
