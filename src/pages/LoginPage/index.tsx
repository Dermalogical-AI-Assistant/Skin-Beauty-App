...
const LoginPage: React.FC = () => {
    ...
    return (
            <BackgroundWrapper>
                <div className={`flex flex-col items-center h-full w-full bg-white rounded-2xl shadow-lg p-5 select-none`}>

                    <div className={`flex flex-col items-center justify-center w-full h-full bg-white rounded-2xl shadow-lg p-5 select-none`}>
                      {/* image */}
                      <div className={`h-27`}>
